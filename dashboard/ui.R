...
# Body --------------------------------------------------------------------
    dashboardBody(
        ...
        tabItem(tabName = "instr",
                h2("Instruções"),
                br(),
                h3("Sobre a dashboard Escola Segura"),
                br(),
                p("A dashboard Escola Segura, desenvolvida pelo Instituto Gesto, é uma plataforma para o monitoramento de casos de covid-19 na comunidade escolar, seja em uma escola em específico ou em toda uma rede de ensino."),
                p("Segundo o Dr. Márcio Bittencourt, as medidas pouco custosas são por vezes as mais efetivas para prevenção da covid-19. A dashboard é baseada na conclusão de estudo publicado na revista Science de medidas com maiores resultados na prevenção do contágio em escolas. Por ordem, as medidas são:"),
                ...
                br(),
                h3("Versão de testes"),
                p("A versão atual da dashboard é uma versão de testes e nem todas as funcionalidades estão disponíveis. Com o preenchimento dos dados pelas escolas, estas opções estarão ativas."),
                tags$ul(tags$li("Os dados na seção download é igual para todas as cidades."),
                    ...
                    tags$li("Novas informações ou visualizações podem ser adicionadas ou já estão em desenvolvimento. O que é exibido na dashboard é o que já está consolidado.")),
